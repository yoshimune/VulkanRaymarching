#include "ReflectionAndSoftShadow.h"
...
// 準備
void ReflectionAndSoftShadow::prepare()
{
	// 頂点情報構築
	prepareGeometry();
...
// クリーンアップ
void ReflectionAndSoftShadow::cleanup()
{
...
// バッファオブジェクトを作成する
ReflectionAndSoftShadow::BufferObject ReflectionAndSoftShadow::createBuffer(uint32_t size, VkBufferUsageFlags usage, VkMemoryPropertyFlags flags)
{
	BufferObject obj;
...
ReflectionAndSoftShadow::ShaderParameters ReflectionAndSoftShadow::createShaderParameters()
{
	// ユニフォームバッファの中身を更新する
...
void ReflectionAndSoftShadow::prepareUniformBuffer()
{
	// ユニフォームバッファ
...
VkPipelineShaderStageCreateInfo ReflectionAndSoftShadow::loadShaderModule(const char* fileName, VkShaderStageFlagBits stage)
{
...
void ReflectionAndSoftShadow::createAlphaPipelineInfo(
	vector<VkPipelineShaderStageCreateInfo>* shaderStages,
	VkPipelineDepthStencilStateCreateInfo* depthStencilCI,
	VkPipelineColorBlendAttachmentState* blendAttachment,
	VkPipelineColorBlendStateCreateInfo* cbCI)
...
void ReflectionAndSoftShadow::prepareDescriptorSet()
{
